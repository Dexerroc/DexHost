...
const publicPages: Record<PublicPageKey, PublicPageContent> = {
  ...
  impressum: {
    ...
    sections: [
      { title: "Diensteanbieter", body: "Dexsolutions\nBjörn Peters\nMünsterstraße 419\n45721 Haltern am See\nDeutschland" },
      { title: "Kontakt", body: "E-Mail: info@dexsolutions.de\nWebsite: https://dexsolutions.de\nProduktseite: https://dexhost.de" },
      { title: "Umsatzsteuer-ID", body: "Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz:\nDE322405038" },
      ...
      { title: "Redaktionell verantwortlich", body: "Björn Peters\nMünsterstraße 419\n45721 Haltern am See" },
      { title: "Streitbeilegung", body: "Die EU-Plattform zur Online-Streitbeilegung wurde zum 20. Juli 2025 eingestellt. Wir sind nicht verpflichtet und nicht bereit, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen." },
  ...
  datenschutz: {
    ...
    intro: "Diese Datenschutzerklärung beschreibt, wie DexHost personenbezogene Daten verarbeitet.",
